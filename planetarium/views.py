...
from planetarium.serializers import (
    ...
    AstronomyShowDetailSerializer, AstronomyShowImageSerializer, ShowSessionSerializer, ShowSessionListSerializer,
    ...
    @extend_schema(
        parameters=[
            OpenApiParameter(
                ...
                description="Filter by show theme id (ex. ?show_themes=2,3)",
            ),
            OpenApiParameter(
                "title",
